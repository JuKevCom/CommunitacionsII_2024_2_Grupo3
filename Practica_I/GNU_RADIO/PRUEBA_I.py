...
import PRUEBA_I_epy_block_1 as epy_block_1  # embedded python block
...
class PRUEBA_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['Acumulador', 'Diferenciador', 'Entrada', 'Signal 4', 'Signal 5',
        ...
        labels = ["Acumulador", "Diferenciador", "Entrada", '', '',
            '', '', '', '', '']
        units = ['', '', '', '', '',
            '', '', '', '', '']
        ...
        self.qtgui_number_sink_0.set_block_alias("Acumulador")
        self.epy_block_1 = epy_block_1.blk()
        self.epy_block_0 = epy_block_0.blk()
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 10, 0.5, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_number_sink_0, 2))
        ...
        self.connect((self.epy_block_1, 0), (self.qtgui_number_sink_0, 1))
